...
export type CreateOrderPreviewResponse = Brand<PostOrderPreviewResponse, 'CreateOrderPreviewResponse'>;
...
export type CreateOrderResponse = Brand<internalCreateResp, 'CreateOrderResponse'>;
